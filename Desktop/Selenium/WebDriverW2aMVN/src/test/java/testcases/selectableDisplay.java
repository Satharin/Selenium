...
public static void selectableDisp(String browser, String user, String password, int number){
		...
		selectList.get(number-1).click();
		
		String check = selectList.get(number-1).getText();
