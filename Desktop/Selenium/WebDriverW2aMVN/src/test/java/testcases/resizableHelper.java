...
public class resizableHelper {
	...
	public static void resizableHel(String browser, String user, String password, int x, int y){
		...
		WebElement defaultSel = driver.findElement(By.xpath(".//*[@id='wrapper']/div/div[1]/div[1]/ul/li[4]"));
		defaultSel.click();
		...
		if(resWidthAfter == (resWidth + x) && resHeightAfter == (resHeight + y)){
