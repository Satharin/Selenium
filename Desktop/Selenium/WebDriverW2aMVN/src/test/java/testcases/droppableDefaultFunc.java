...
public class droppableDefaultFunc {
	

	public static void droppableDefault(String browser, String user, String password){
	...
	block.click();
		...
		String check = driver.findElement(By.xpath(".//*[@id='droppable']/p")).getText();
		
		driver.switchTo().defaultContent();
		
		
		
		if(check.equals("Dropped!")){
