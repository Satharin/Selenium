...
public class sortableDefault {

public static void sortableDef(String browser, String user, String password, int itemToChange, int itemToChangeWith){
		...
		WebElement display = driver.findElement(By.xpath(".//*[@id='wrapper']/div/div[1]/div[1]/ul/li[1]"));
		display.click();
