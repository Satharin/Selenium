...
public class selectableDefault {
	

	public static void selectableDef(String browser, String user, String password, int number){
		...
		String check = list6.get(number-1).getText();
		
		driver.switchTo().defaultContent();
		
		if(check.equals("Item " + Integer.toString(number))){
